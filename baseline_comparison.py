...
EXPERIMENT_CONFIG = {
    ...
    'strategy_labels': {
        ...
        'mexclp': 'MEXCLP運用',
        # ↓ PPOスロット用の表示名
        'ppo_slot1': 'PPOエージェント（hybrid_unified_v8d2）',
        'ppo_slot2': 'PPOエージェント（hybrid_unified_v8h）',
    ...
    'strategy_configs': {
        ...
        'ppo_slot1': {
            'model_path': str(
                ...
                / 'experiments'
                / 'ppo_training'
                / 'hybrid_unified_v8d2_quick'  # ←ここを差し替えてください
                / 'checkpoints'
                / 'best_model.pth'
            ),
            'config_path': str(
        ...
        'ppo_slot2': {
            'model_path': str(
                ...
                / 'experiments'
                / 'ppo_training'
                / 'hybrid_unified_v8h_quick'  # ←ここを差し替えてください
                / 'checkpoints'
                / 'best_model.pth'
            ),
            'config_path': str(
        ...
        'ppo_slot3': {
            'model_path': str(
                ...
                / 'experiments'
                / 'ppo_training'
                / 'hybrid_unified_v6b_quick'  # ←ここを差し替えてください
                / 'checkpoints'
                / 'best_model.pth'
            ),
            'config_path': str(
